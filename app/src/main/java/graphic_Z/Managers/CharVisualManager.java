...
public class CharVisualManager extends VisualManager<CharWorld> implements Runnable
{
	...
	public CharVisualManager(short resolution_X, short resolution_Y, CharWorld inWhichWorld, TextView main_scr)
	{
