...
public class GamePadViewAll2 extends View implements Runnable
{
    ...
    private boolean isShowBack = true;//是否使用返回键
...
////////////////////////////////////////
	...
	public GamePadViewAll2(Context context)
	{
		super(context);
		initView();
	}
/*
    ...
    */
	...
	private void initView()
	{
        ...
        this.btn_sright = new RectButton(0,0,rect_w,rect_h);
        ...
        if(isShowBack)list_btn.add(btn_sright);
        list_btn.add(btn_ok);
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom)
	{
        ...
        this.btn_down.setXY(rect_w,start_y+rect_h);
        this.btn_ok.setXY(rect_w*2, start_y);  
        this.btn_sright.setXY(right- rect_w,start_y-rect_h);
